...
func flowParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"IN", "AND", "OR", "UNLESS", "NUMBER", "DURATION_UNIT", "IDENTIFIER",
	...
	staticData.serializedATN = []int32{
		4, 1, 35, 125, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		6, 3, 0, 45, 3, 1, 0, 0, 0, 46, 47, 5, 31, 0, 0, 47, 48, 5, 7, 0, 0, 48,
		...
		31, 0, 0, 62, 68, 5, 29, 0, 0, 63, 64, 5, 2, 0, 0, 64, 65, 3, 6, 3, 0,
		...
		15, 1, 0, 0, 0, 82, 84, 5, 31, 0, 0, 83, 82, 1, 0, 0, 0, 83, 84, 1, 0,
		...
		0, 0, 0, 99, 100, 5, 31, 0, 0, 100, 101, 7, 1, 0, 0, 101, 102, 5, 32, 0,
		0, 102, 19, 1, 0, 0, 0, 103, 104, 5, 22, 0, 0, 104, 117, 7, 2, 0, 0, 105,
		114, 5, 2, 0, 0, 106, 111, 5, 31, 0, 0, 107, 108, 5, 1, 0, 0, 108, 110,
		5, 31, 0, 0, 109, 107, 1, 0, 0, 0, 110, 113, 1, 0, 0, 0, 111, 109, 1, 0,
		...
		0, 0, 0, 119, 120, 5, 31, 0, 0, 120, 121, 5, 23, 0, 0, 121, 23, 1, 0, 0,
		0, 122, 123, 5, 31, 0, 0, 123, 25, 1, 0, 0, 0, 13, 32, 40, 56, 67, 74,
...
const (
	...
	FlowParserUNLESS            = 28
	FlowParserNUMBER            = 29
	FlowParserDURATION_UNIT     = 30
	FlowParserIDENTIFIER        = 31
	FlowParserSTRING            = 32
	FlowParserCOMMENT           = 33
	FlowParserMULTILINE_COMMENT = 34
	FlowParserWS                = 35
)
